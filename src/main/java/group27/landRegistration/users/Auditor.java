...
public class Auditor extends User {
    ...
    public void markPermissionForReview(group27.landRegistration.nonUsers.UserPermission perm) {
        ...
        group27.landRegistration.nonUsers.SystemActivityLog logEntry =
                new group27.landRegistration.nonUsers.SystemActivityLog(
                        0, // ID will be auto-generated by static block logic or ignored if constructor handles it
                        this.getUserID(),
    ...
    // TEMPORARY: For testing Pie Chart visuals
    public void generateDummyApplications() {
        ...
        // 3 Approved
        apps.add(new Application(101, 1003, "Approved", "All good", now.minusDays(5), now));
        apps.add(new Application(102, 1003, "Approved", "Verified", now.minusMonths(1), now.minusWeeks(3)));
        apps.add(new Application(103, 1004, "Approved", "Done", now.minusMonths(2), now.minusMonths(2)));

        // 2 Rejected (These are missing currently!)
        apps.add(new Application(104, 1004, "Rejected", "Invalid docs", now.minusDays(2), now));
        apps.add(new Application(105, 1003, "Rejected", "Dispute found", now.minusDays(10), now.minusDays(1)));

        // 4 Pending
        apps.add(new Application(106, 1005, "Pending", "Reviewing", now, null));
        apps.add(new Application(107, 1005, "Pending", "Waiting", now, null));
        apps.add(new Application(108, 1005, "Pending", "New", now, null));
        apps.add(new Application(109, 1005, "Pending", "New", now, null));
